...
style_mono_light(
  ...
  text_font_size = "28px",footnote_font_size = "22px",
)
```
...
(`r icon::fa("envelope")`laderast@ohsu.edu | [`r icon::fa("twitter")`](https://twitter.com/tladeras) [tladeras](https://twitter.com/tladeras))
